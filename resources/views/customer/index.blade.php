...
<section ng-controller="PaymentController">
    <div class="mt-3 ml-4 mr-3 mb-0 d-flex flex-row align-items-center justify-content-between">
        <h6 class="font-weight-bold text-primary pt-3">Customers</h6>
        <a type="button" class="btn btn-primary me-2 d-flex" href="{{route('customer.create')}}">New</a>
    </div>
    <hr />
  <div class="card-body">
               ...
               <tr>
                 ...
                 <td>
                  ...
                  <td>
                    ...
                    <a style="cursor: pointer" data-toggle='tooltip' data-placement="right" href='{{route('customer.edit',$customer->id)}}' title="Edit Customer" class="text-info"> <i class="fas fa-fw fa-pen"></i></a>
                  <a style="cursor: pointer"  data-toggle='tooltip' data-placement="right" ng-click="delete({{$customer->id}})" title="Delete Customer" class="ml-3 text-danger"> <i class="fas fa-fw fa-trash"></i></a> 
